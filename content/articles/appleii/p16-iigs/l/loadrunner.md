...
Load Runner is the first boot virus for the GS, designed by Les Artistes Associés in 1988. It has a very clean appearance, is complete, and has a nice programming style. A big thank you to the Artistes. Here are a few characteristics to help you locate it correctly. This virus only acts on slot 5, device 1. If you plug your drive into slot 7, you won't be infected, which is rather annoying. This virus vectorizes the control-reset in *E1/1688. When it triggers, an alarm and a countdown give you a bit of a scare. It should also be noted that this virus self-destructs viciously (leaving no trace, installing Zero everywhere in its territory), unlike Apocalypse I which disappears more gently... a story about Load Runner: When this dear virus landed on the new continent, it caused quite a stir. The text of this virus is written in French, which meant nothing to our Americans. So they tackled French as a second step. They managed to translate a large part, but one detail was missing... here's the mistake: the text said "The first non-destructive virus on GS". And they translated it as "The first indestructible virus on GS" (right?). And then they (surprising, isn't it?) got really worried. The workaround with Command-Control-Reset matched their translations perfectly. They were able to sleep soundly, noticing that on the French copiers and antivirus software it said "Virus Load Runner detected".
